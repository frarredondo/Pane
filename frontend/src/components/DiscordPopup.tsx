    ...
    <Modal isOpen={isOpen} onClose={handleClose} size="md" ariaLabel="Join the Pane Community">
      <div className="relative overflow-hidden -m-6 mb-0">
        ...
        <div className="relative px-6 py-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Join the Pane Community!</h2>
          <p className="text-white/90">Connect with other Pane users, get help, and stay updated</p>
        </div>
      </div>
      ...
      <ModalBody>
          <div className="space-y-4 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-text-secondary">Get help with Pane and Claude Code</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 rounded-full bg-[#5865F2] mt-2 flex-shrink-0" />
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full px-4 py-3 bg-discord hover:bg-discord-hover text-white font-medium rounded-lg transition-colors flex items-center justify-center space-x-2"
            >
